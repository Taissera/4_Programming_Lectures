...
// А потом показывать её в консоле. Перезапустим. Опять же изменим значение. Например, 31 здесь поставим. И спустя какое-то время мы с вами
// наблюдаем сумму чисел. Вроде бы всё. Сравним с нашей блок схемой. Убедимся, что определили // numberА и numberВ , показали сумму. 
